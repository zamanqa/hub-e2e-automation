...
describe('Order Creation - Add Items with Different Subscription Types', () => {
  ...
  it('should create an order with three subscription items (service, consumable, digital)', () => {
    // Step 1: Verify we're on the Order Creation page
    ...
    // Step 2: Click "Add item" button again
    OrderCreationPage.clickAddItem();
    OrderCreationPage.verifyDialogOpened();
    ...
    // Step 6: Select Type - Consumable
    OrderCreationPage.selectTypeByName('consumable');
    ...
    // ========== THIRD ITEM: DIGITAL TYPE ==========
    cy.log('========== Adding Item 3: DIGITAL TYPE ==========');
    ...
    // Step 6: Select Type - Digital
    OrderCreationPage.selectTypeByName('digital');
    ...
    cy.log('========== ALL THREE ITEMS ADDED SUCCESSFULLY ==========');

    // ========== FILL BILLING ADDRESS ==========
    OrderCreationPage.fillBillingAddress(testData.billingAddress);

    // ========== ENABLE CHARGE BY INVOICE ==========
    cy.log('========== Enabling Charge by Invoice ==========');
    OrderCreationPage.enableChargeByInvoice();
